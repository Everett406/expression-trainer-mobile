 ...
 *
 * ES module 版本：词库数据通过 import 直接加载，不再读文件系统
 */

import emotionLexicon from '../data/emotion-lexicon.json';

let lexiconData = emotionLexicon;
...
/**
 * 加载词库
 * ES module 版本：直接从 import 的 JSON 数据加载，不再读文件系统
 */
function loadLexicon() {
  lexiconData = emotionLexicon;
...
export { loadLexicon, analyzeText, VAGUE_TO_PRECISE, FILLER_WORDS, HEDGE_WORDS };
